...
rect1 = plt.bar(x - 0.45 * width, encrypt, fc='#00A8A8', width=0.75 * width, label='Encrypt', yerr=error, capsize=8,
        hatch="\\\\\\", edgecolor="k", zorder=1.8)
rect2 = plt.bar(x + 0.45 * width, decrypt, fc='#730000', width=0.75 * width, label='Decrypt', yerr=error, capsize=8,
