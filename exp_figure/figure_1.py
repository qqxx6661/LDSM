...
plt.bar(x - 0.45 * width, encrypt, fc='#03BABA', width=0.75 * width, label='Encrypt', yerr=error, capsize=8,
        hatch="\\\\\\", edgecolor="k", zorder=1.8)
plt.bar(x + 0.45 * width, decrypt, fc='#800000', width=0.75 * width, label='Decrypt', yerr=error, capsize=8,
